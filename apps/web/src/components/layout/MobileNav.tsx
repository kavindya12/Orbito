...
export function MobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-[var(--border)] bg-[var(--card)]/95 px-2 py-2 backdrop-blur-md lg:hidden">
